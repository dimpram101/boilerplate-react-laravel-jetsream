...
const Edit = ({ user, roles }: Props) => {
  ...
  return (
    <DashboardLayout>
      <h1 className='text-3xl font-bold text-center mb-4'>Edit - {user.name}</h1>
        ...
        <form onSubmit={(e) => onSubmitHandler(e)}>
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col w-full gap-1">
              ...
              <input type="email" className='rounded-lg p-2' placeholder='example@gmail.com' value={form.data.email} onChange={(e) => form.setData('email', e.target.value)} disabled/>
            </div>
            <div className="flex flex-col w-full gap-1">
